...
# -*- coding: utf-8 -*-
"""
Created on Sat Oct 12 23:46:36 2019
...
#list of training and test sets along each fold
X_train_list = []
X_test_list = []
y_train_list = []
y_test_list = []

#preparing lists for K fold
for train_ind, test_ind in kf.split(X):
    normalizer = StandardScaler()
    X_train_list.append(normalizer.fit_transform(X[train_ind]))
    X_test_list.append(normalizer.fit_transform(X[test_ind]))    
    y_train_list.append(y[train_ind])
    y_test_list.append(y[test_ind])
